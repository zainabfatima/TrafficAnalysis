...
# Counters and vehicle tracking sets
zoneAcounter = set()
zoneBcounter = set()
zoneCcounter = set()
zoneDcounter = set()
...
while True:
    ...
    for info in results:
        ...
        for box in parameters:
            ...
            if class_detect in ['car', 'truck', 'bus'] and conf > 30:
                deepsort_detections.append([[x1, y1, x2 - x1, y2 - y1], confidence, class_detect])
    ...
    track_results = tracker.update_tracks(deepsort_detections, frame=frame)
    ...
    for result in track_results:
        ...
        cv2.circle(frame, bottom_middle, 5, (0, 0, 255), -1)  # Red
        cv2.circle(frame, right_middle, 5, (255, 0, 0), -1)   # Blue
        cv2.circle(frame, (cx, cy), 5, (0, 255, 0), -1)       # Green
        cv2.circle(frame, top_right, 5, (190, 100, 100), -1)  # Gray-blue
        cv2.circle(frame, (right_cx, cy), 5, (0, 255, 255), -1)  # Yellow
        cv2.circle(frame, (mid_cx, cy), 5, (255, 255, 0), -1)    # Cyan
    ...
    draw_text(frame, f'Total sum: {total_detected_vehicles}', [9, 510+ 15 * 11], (66, 98, 255))
